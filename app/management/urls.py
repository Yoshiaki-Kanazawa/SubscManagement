...
urlpatterns = [
    ...
    path('<int:userid>', views.UserDelete.as_view(), name='userDelete'),
    path('add/', views.AddService.as_view(), name='addService'),
    path('detail/<int:serviceid>', views.Detail.as_view(), name='detail'),
    path('<int:serviceid>', views.Update.as_view(), name='update'),
    path('<int:serviceid>', views.Delete.as_view(), name='delete'),
]